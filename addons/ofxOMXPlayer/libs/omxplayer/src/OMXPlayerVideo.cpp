...
void OMXPlayerVideo::Output(double pts)
{
  if(m_syncclock)
  {
    ...
    //ofLog(OF_LOG_VERBOSE, "OMXPlayerVideo - GENERAL_RESYNC(%f, 1) delay %f\n", pts, m_FlipTimeStamp);
  ...
  /*
  ofLog(OF_LOG_VERBOSE, "iPlayingClock %f iCurrentClock %f iClockSleep %f iFrameSleep %f iFrameDuration %f WaitAbsolut %f m_FlipTimeStamp %f pts %f\n", 
