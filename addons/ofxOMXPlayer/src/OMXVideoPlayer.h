...
public:
 ...
 double                    m_pts;
	...
	void LockDecoder();
	void UnLockDecoder();
	bool Open(COMXStreamInfo &hints, OMXClock *av_clock, EGLImageKHR eglImage_) {return false;};
	bool Open(COMXStreamInfo &hints, OMXClock *av_clock, bool deinterlace, bool mpeg, bool hdmi_clock_sync, bool use_thread, float display_aspect) {return false;};
