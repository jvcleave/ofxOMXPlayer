...
bool COMXVideo::Open(COMXStreamInfo &hints, OMXClock *clock)
{
 ...
 m_omx_tunnel_decoder.Initialize(&m_omx_decoder, m_omx_decoder.GetOutputPort(), &m_omx_sched, m_omx_sched.GetInputPort());
  ...
  if (omx_err != OMX_ErrorNone)
  {
    printf("\nCOMXVideo::Open AllocOMXInputBuffers error (0%08x)\n", omx_err);
    return false;
  }
  ...
  if(omx_err != OMX_ErrorNone)
  {
    printf("\nCOMXVideo::Open m_omx_tunnel_decoder.Establish\n");
    return false;
  }
  ...
  if (omx_err != OMX_ErrorNone)
  {
    printf("\nCOMXVideo::Open error m_omx_decoder.SetStateForComponent\n");
    return false;
  }
  ...
  if(omx_err != OMX_ErrorNone)
  {
    printf("\nCOMXVideo::Open m_omx_tunnel_sched.Establish\n");
    return false;
  }
  ...
  if (omx_err != OMX_ErrorNone)
  {
    printf("\nCOMXVideo::Open error m_omx_sched.SetStateForComponent\n");
    return false;
  }
  ...
  if (omx_err != OMX_ErrorNone)
  {
    printf("\nCOMXVideo::Open error m_omx_render.SetStateForComponent\n");
    return false;
  }
